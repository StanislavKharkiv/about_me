    ...
    <div className={styles.container}>
      <div className={styles.logoWrapper}>
        <div className={styles.iconWrapper}>
          ...
          >
            <g transform="translate(0.000000,256.000000) scale(0.100000,-0.100000)" fill="#f8f6f6" stroke="none">
          ...
          <span className={styles.scan}></span>
        </div>
        <span className={styles.name}>Stanislav Iosyfov</span>
      </div>
      <div className={styles.statusBadge}>
        <span className={styles.pulseDot}></span>
        <span>
          <span className={styles.statusCode}>System Status: 200 OK</span>
